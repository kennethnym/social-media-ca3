...
public interface SocialMediaPlatform extends MiniSocialMediaPlatform {
	 ...
	 */
	int createAccount(String handle, String description) throws IllegalHandleException, InvalidHandleException, IllegalHandleException, InvalidHandleException;
	 ...
	 */
	void removeAccount(String handle) throws HandleNotRecognisedException, HandleNotRecognisedException;
